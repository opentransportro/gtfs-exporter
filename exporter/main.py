...
from exporter import __version__ as version, __output_path__ as out_path, __cwd_path__, __output_path__
from exporter.api import ApiBuilder
from exporter.provider import DataProvider, FileDataProvider, HttpDataProvider
from exporter.settings import SSH_ADDRESS, SSH_PASS, SSH_PORT, SSH_USER, SSH_FOLDER
...
def main():
    ...
    rg = SFTPReleaseGenerator("data.opentransport.ro", 59100, "data", "Su7aemoo_eo4Mait2_Io6Piet9", "/var/www/data.opentransport.ro/routing/gtfs/")
