...
from exporter.gtfs.csvgtfs import Gtfs, ZipFileSource
from exporter.gtfs.model import FeedInfo, Agency, Route, Calendar, CalendarDate, Stop, \
    Trip, StopTime, Transfer, Shape, Zone, FareAttribute, FareRule, ShapePoint
from exporter.gtfs.orm import _Orm
from exporter.gtfs.utils import group_pairs
...
class Dao(object):
    ...
    def trips(self, fltr=None, prefetch_stop_times=True, prefetch_routes=False, prefetch_stops=False,
              prefetch_calendars=False, batch_size=800):
