...
from exporter.gtfs.model import FeedInfo, Agency, Stop, Route, Calendar, CalendarDate, \
...
class _Orm(object):
    ...
    def __init__(self, engine, schema=None):
        ...
        for _mapper in self.mappers:
            self._class_for_table[_mapper.persist_selectable.name] = _mapper.class_
            self._table_for_class[_mapper.class_] = _mapper.persist_selectable.name
