...
from exporter.gtfs.model import CalendarDate, Route, Calendar, Stop, \
    Trip, StopTime
from exporter.gtfs.spatial import RectangularArea, SpatialClusterizer
from exporter.gtfs.utils import gtfstime

base_path = dirname(abspath(__file__))
# Location of dummy.gtfs.zip.
# This unit-test is highly dependent on the CONTENT of this GTFS.
DUMMY_GTFS = base_path + "/data/gtfs/dummy.gtfs.zip"
