...
from exporter.gtfs.spatial import orthodromic_distance
...
GTFS_LIST = [ base_path + "/data/gtfs/mini.gtfs.zip", base_path + "/data/gtfs/dummy.gtfs.zip", base_path + "/data/gtfs/sample-feed.zip" ]
